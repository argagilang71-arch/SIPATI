...
export const INITIAL_ARCHIVES: ArchiveItem[] = [
  ...
  {
    id: 'arch-2',
    title: 'Laporan Keuangan Triwulan II',
    noSurat: '112/LAP-KEU/Q2/VII/2026',
    bidang: 'Keuangan & Audit',
    date: '02 Agustus 2026',
    status: 'FINAL',
    fileType: 'pdf',
    description: 'Laporan pertanggungjawaban penggunaan anggaran persiapan dan verifikasi bukti kas keluar.',
    fileSize: '4.8 MB'
  },
  {
    id: 'arch-3',
    title: 'Draft Proposal Pengadaan Barang Lama',
